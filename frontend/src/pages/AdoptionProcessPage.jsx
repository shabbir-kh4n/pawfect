        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="flex justify-center mb-6">
            <div className="bg-orange-500 p-4 rounded-full">
              <IoMdHeart className="text-white text-4xl" />
            </div>
          </div>
          ...
          <div className="text-center text-gray-600 space-y-4">
            <p className="text-lg">
              Welcome to the Adoption Process section!
            </p>
            <p>
              This page will guide you through every step of the pet adoption journey, from browsing available pets to completing the adoption paperwork and bringing your new companion home.
            </p>
